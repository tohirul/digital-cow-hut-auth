...
AdminSchema.methods.passwordMatch = async function (givenPassword, savedPassword) {
    return await bcrypt_1.default.compare(givenPassword, savedPassword);
};
AdminSchema.methods.findExistingById = async function (property) {
    const result = await Admin.findById({ _id: property });
    return result;
};
AdminSchema.methods.findExistingByPhone = async function (property) {
